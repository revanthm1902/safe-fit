...
const OnboardingScreen = ({
  ...
  return <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          duration: 0.3
            ...
            <Card className="p-8 bg-white/10 backdrop-blur-lg border border-white/20 text-center">
              ...
              <div className="flex justify-center space-x-2 mb-8">
                {steps.map((_, index) => <div key={index} className={`w-2 h-2 rounded-full transition-all duration-300 ${index === currentStep ? 'bg-teal-400 w-8' : 'bg-gray-600'}`} />)}
              </div>
