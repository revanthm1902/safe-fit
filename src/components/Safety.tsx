  ...
  return (
    <div className="min-h-screen bg-safefit-white p-4 pt-20 pb-24">
      ...
      >
        ...
        <p className="text-safefit-primary">Your protection is our priority</p>
      </motion.div>
      ...
      <motion.div
        ...
        className="mb-6"
      >
        <Card className="p-6 bg-gradient-to-r from-red-50 to-pink-50 border border-red-100">
          <div className="flex items-center mb-4">
            ...
            <div>
              ...
              <p className="text-safefit-primary text-sm">Quickly alert your emergency contacts</p>
            </div>
          </div>
          <Button 
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  <Card className="p-4 border border-safefit-border hover:border-safefit-highlight hover:shadow-sm transition-all cursor-pointer">
                    <div className="flex items-start space-x-3">
                      <div className="bg-safefit-light p-2 rounded-full">
                        <Icon className="h-5 w-5 text-safefit-highlight" />
                      </div>
                      <div>
                        <h4 className="font-medium text-safefit-dark">{item.title}</h4>
                        <p className="text-xs text-safefit-primary">{item.description}</p>
                      </div>
                    </div>
                  </Card>
                </motion.div>
      ...
      >
        <Card className="p-6 border border-safefit-border bg-white">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <div className="bg-safefit-light p-1 rounded-full mt-1">
              ...
              <div>
                ...
                <p className="text-xs text-safefit-primary">Always be conscious of your environment, especially in unfamiliar areas.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="bg-safefit-light p-1 rounded-full mt-1">
              ...
              <div>
                ...
                <p className="text-xs text-safefit-primary">Regularly check and update your emergency contacts in the app.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="bg-safefit-light p-1 rounded-full mt-1">
              ...
              <div>
                ...
                <p className="text-xs text-safefit-primary">Regularly test the SOS feature to ensure it works when needed.</p>
              </div>
            </div>
          </div>
        </Card>
